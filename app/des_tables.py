# Constants for DES - Data Encryption Standard
...
# Final Permutation (IP Inverse) - 64 bits
...
# Permuted Choice 2 (PC-2) - 56 bits -> 48 bits (Subkey)
...
# S_BOXES[0] is S1, S_BOXES[7] is S8
S_BOXES = [
    # S1
